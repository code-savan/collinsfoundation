      ...
      <section id="team" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-to-br from-[#8dc220]/5 to-[#007acc]/5 p-12 rounded-3xl border border-slate-200">
              <div className="text-center">
                <div className="w-40 h-40 bg-gradient-to-br from-[#8dc220] to-[#7bb01c] rounded-full mx-auto mb-6 flex items-center justify-center shadow-lg overflow-hidden">
                  <Image
                  alt="Collins Onyeaji"
                  src="/collins.jpeg"
                  className="w-full h-full object-cover"
                ...
                <h3 className="text-3xl font-roboto font-bold text-gray-900 mb-2">
                  Collins Onyeaji
                </h3>
                <p className="text-lg text-[#8dc220] font-inter mb-6">
                  Founder & Executive Director
                </p>
                <p className="text-gray-600 font-inter leading-relaxed text-[15px] max-w-2xl mx-auto">
                  With a passion for community development and years of experience in the nonprofit sector, Collins Onyeaji founded the foundation with a vision to transform rural communities through sustainable initiatives in education, agriculture, and healthcare.
                </p>

                {/* <div className="flex justify-center space-x-4 mt-8">
                  <div className="w-10 h-10 bg-[#8dc220] rounded-full flex items-center justify-center hover:bg-[#7bb01c] transition-colors cursor-pointer">
                    <span className="text-white font-bold">in</span>
                  </div>
                  <div className="w-10 h-10 bg-[#007acc] rounded-full flex items-center justify-center hover:bg-[#005a99] transition-colors cursor-pointer">
            ...
            <div className="text-center mt-12">
              <p className="text-xs text-gray-600 font-inter max-w-2xl mx-auto">
